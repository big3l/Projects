...
jQuery(function ($) {
  ...
  var App = {
    ...
    bindEvents: function () {
      ...
      // delegateEvent(newtodo, "keyup", this.create.bind(this));

      let toggleAll = document.querySelector("toggle-all");
      delegateEvent(toggleAll, "change", this.toggleAll.bind(this));

      let footer = document.querySelector("footer");
      let clearcompleted = document.querySelector("clear-completed")
      delegateEvent(footer, "click", clearcompleted, this.destroyCompleted.bind(this))
